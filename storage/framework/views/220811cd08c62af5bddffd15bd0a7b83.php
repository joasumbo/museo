...
<?php $__env->startSection('title', 'O Museu - Museu Municipal de Alcanena'); ?>

<?php $__env->startSection('description', 'Conheça o Museu Municipal de Alcanena, um espaço dedicado à preservação, investigação e divulgação do rico Património cultural e histórico do concelho.'); ?>

<?php $__env->startSection('content'); ?>
        <!--==============================
        Breadcumb
        ============================== -->
        <div class="breadcumb-wrapper text-center" data-bg-src="<?php echo e(asset('assets/img/gallery/DSC_3893.jpg')); ?>" data-overlay="dark" data-opacity="6" style="background-size: cover; background-position: center; position: relative;">
                ...
                <div class="row gy-50 gx-60 justify-content-lg-between align-items-center">
                    <div class="col-xl-5">
                        <div class="about-page-thumb wow custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.1s">
                            <img src="<?php echo e(asset('assets/img/gallery/DSC_3932.jpg')); ?>" alt="Museu Municipal de Alcanena">
                        </div>
                    </div>
                    <div class="col-xl-7">
            ...
            <div class="container">
                ...
                <div class="row justify-content-center exhibition-wrap-1 gy-40 gx-30">
                    <div class="col-lg-4 col-md-6 exhibition-card-wrap">
                        <div class="exhibition-card gtop">
                            <div class="exhibition-card-thumb">
                                <img src="<?php echo e(asset('assets/img/exhibition/mma_1.jpg')); ?>" alt="Exposição">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 exhibition-card-wrap">
                        <div class="exhibition-card gtop">
                            <div class="exhibition-card-thumb">
                                <img src="<?php echo e(asset('assets/img/exhibition/mma_2.jpg')); ?>" alt="Exposição">
                            </div>
                            <div class="exhibition-card-details">
                                <div class="post-meta-item blog-meta">
                    ...
                    <div class="col-lg-4 col-md-6 exhibition-card-wrap">
                        <div class="exhibition-card gtop">
                            <div class="exhibition-card-thumb">
                                <img src="<?php echo e(asset('assets/img/exhibition/mma_3.jpg')); ?>" alt="Exposição">
                            </div>
                            <div class="exhibition-card-details">
                                <div class="post-meta-item blog-meta">
                                    <a href="event.html">EXPOSIÇÃO PERMANENTE</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bravantic\Desktop\Museu Municipal Alcanena\resources\views/sobre.blade.php ENDPATH**/ ?>