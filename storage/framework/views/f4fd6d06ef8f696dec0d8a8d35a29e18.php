...
<?php $__env->startSection('title', 'Museu Municipal de Alcanena - Cultura e História'); ?>
<?php $__env->startSection('description', 'Museu Municipal de Alcanena - Espaço dedicado à preservação e divulgação do Património cultural e histórico de Alcanena'); ?>
<?php $__env->startSection('keywords', 'Museu, Alcanena, Cultura, História, Património, Exposições, Eventos'); ?>
...
==============================-->
    <div class="hero-wrapper hero-1" id="hero-sec">
        <div class="global-carousel hero-slider1" id="heroSlider1" data-fade="true" data-slide-show="1" data-lg-slide-show="1" data-md-slide-show="1" data-sm-slide-show="1" data-xs-slide-show="1" data-arrows="false" data-asnavfor=".hero-custom-dots">
            <div class="hero-slider" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('<?php echo e(asset('assets/img/hero/hero_mma_2.jpg')); ?>'); background-size: cover; background-position: center; min-height: 500px;">
                <div class="hero-thumb1" data-ani="slider-custom-anim-left" data-ani-delay="0.1s" style="display: none;">
                    <img src="<?php echo e(asset('assets/img/hero/hero_mma_2.jpg')); ?>" alt="Museu Municipal Alcanena">
                </div>
                <div class="hero-thumb2" data-ani="slider-custom-anim-right" data-ani-delay="0.1s" style="display: none;">
                    <img src="<?php echo e(asset('assets/img/hero/hero_mma_3.jpg')); ?>" alt="Museu Municipal Alcanena">
                </div>
                <div class="container">
    ...
    <div class="space bg-title">
        <div class="container">
            ...
            <div class="row justify-content-center exhibition-wrap-1 gy-40 gx-30">
                <?php $__empty_1 = true; $__currentLoopData = $featuredExhibitions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exhibition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-lg-4 col-md-6 exhibition-card-wrap">
                    <div class="exhibition-card gtop">
                        <div class="exhibition-card-thumb">
                            <img src="<?php echo e($exhibition->image ? url('storage/' . $exhibition->image) : asset('assets/img/exhibition/mma_1.jpg')); ?>" alt="<?php echo e($exhibition->title); ?>">
                        </div>
                        <div class="exhibition-card-details">
                            <div class="post-meta-item blog-meta">
                                <a href="<?php echo e(route('eventos')); ?>">
                                    <?php echo e($exhibition->start_date->format('d M, Y')); ?>

                                    <?php if($exhibition->end_date && $exhibition->end_date != $exhibition->start_date): ?>
                                     - <?php echo e($exhibition->end_date->format('d M, Y')); ?>

                                    <?php endif; ?>
                                </a>
                            </div>
                            <h3 class="event-card-title"><a href="<?php echo e(route('eventos')); ?>"><?php echo e($exhibition->title); ?></a></h3>
                            <?php if($exhibition->short_description): ?>
                            <p class="event-text"><?php echo e(Str::limit($exhibition->short_description, 100)); ?></p>
                            <?php endif; ?>
                            <a class="btn style2" href="<?php echo e(route('eventos')); ?>">VER DETALHES</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid wow custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.1s">
            <div class="row global-carousel portfolio-slider1 gx-20" data-slide-show="3" >
                <div class="col-lg-4">
                    <div class="portfolio-card ">
                        <div class="portfolio-thumb">
                            <a class="popup-image icon-btn" href="<?php echo e(asset('assets/img/portfolio/mma_portfolio_1.jpg')); ?>"><i class="far fa-eye"></i></a>
                            <img src="<?php echo e(asset('assets/img/portfolio/mma_portfolio_1.jpg')); ?>" alt="portfolio">
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="portfolio-card ">
                        <div class="portfolio-thumb">
                            <a class="popup-image icon-btn" href="<?php echo e(asset('assets/img/portfolio/mma_portfolio_2.jpg')); ?>"><i class="far fa-eye"></i></a>
                            <img src="<?php echo e(asset('assets/img/portfolio/mma_portfolio_2.jpg')); ?>" alt="portfolio">
                        </div>
                        <div class="portfolio-details">
                ...
                <div class="col-lg-4">
                    <div class="portfolio-card ">
                        <div class="portfolio-thumb">
                            <a class="popup-image icon-btn" href="<?php echo e(asset('assets/img/portfolio/mma_portfolio_3.jpg')); ?>"><i class="far fa-eye"></i></a>
                            <img src="<?php echo e(asset('assets/img/portfolio/mma_portfolio_3.jpg')); ?>" alt="portfolio">
                        </div>
                        <div class="portfolio-details">
            ...
            <div class="row justify-content-lg-between justify-content-center text-lg-start text-center">
                ...
                <div class="col-lg-auto">
                    <div class="sec-btn wow custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.1s">
                        <a href="<?php echo e(route('eventos')); ?>" class="btn">
                ...
                <div class="col-lg-12">
                    <div class="event-card wow custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.1s">
                        <div class="event-card-date">
                            <span class="date"><?php echo e(\Carbon\Carbon::parse($event->start_date)->format('d')); ?></span>
                            <?php echo e(\Carbon\Carbon::parse($event->start_date)->locale('pt')->translatedFormat('F, Y')); ?>

                        </div>
                        <div class="event-card-details">
                            <h3 class="event-card-title"><a href="<?php echo e(route('evento.detalhes.bd', $event->slug)); ?>"><?php echo e($event->title); ?></a></h3>
                            <span class="event-card-location">
                                <i class="fas fa-map-marker-alt"></i> 
                                <?php echo e($event->location ?? 'Museu Municipal de Alcanena'); ?>

                            </span>
                            <a href="<?php echo e(route('evento.detalhes.bd', $event->slug)); ?>" class="btn">
                                SABER MAIS
                            </a>
                        </div>
                        <?php if($event->image): ?>
                        <div class="event-card-thumb">
                            <img src="<?php echo e(url('storage/' . $event->image)); ?>" alt="<?php echo e($event->title); ?>">
                        </div>
                        <?php else: ?>
                        <div class="event-card-thumb">
                            <img src="<?php echo e(asset('assets/img/event/mma_event_1.jpg')); ?>" alt="<?php echo e($event->title); ?>">
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 text-lg-end text-center">
                    <div class="wow custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        <a href="<?php echo e(route('agendar.visita')); ?>" class="btn" style="padding: 18px 45px; font-size: 16px; font-weight: 600;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bravantic\Desktop\Museu Municipal Alcanena\resources\views/home.blade.php ENDPATH**/ ?>