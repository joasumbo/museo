        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-8">
                ...
                <div class="text-center mt-40">
                    <a href="<?php echo e(route('agendar.visita')); ?>" class="btn" style="padding: 15px 40px; font-size: 16px; font-weight: 600; display: inline-block;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bravantic\Desktop\Museu Municipal Alcanena\resources\views/horarios.blade.php ENDPATH**/ ?>