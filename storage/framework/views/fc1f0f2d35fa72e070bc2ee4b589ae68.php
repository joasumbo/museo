...
<?php $__env->startSection('title', 'Eventos - Museu Municipal de Alcanena'); ?>
<?php $__env->startSection('description', 'Eventos, exposições e atividades no Museu Municipal de Alcanena'); ?>
...
<div class="space overflow-hidden">
    <div class="container">
        ...
        <div class="row gy-40 filter-active">
            ...
            <div class="col-lg-12 filter-item <?php echo e($event->type); ?>">
                <div class="event-card style2">
                    <div class="event-card-img">
                        <img src="<?php echo e($event->image ? url('storage/' . $event->image) : asset('assets/img/event/mma_event_1.jpg')); ?>" alt="<?php echo e($event->title); ?>">
                        <span class="event-badge"><?php echo e($event->getTypeLabel()); ?></span>
                    </div>
                    <div class="event-card-content">
                        <div class="event-meta">
                            <span class="event-date">
                                <i class="far fa-calendar"></i>
                                <?php echo e(\Carbon\Carbon::parse($event->start_date)->locale('pt')->translatedFormat('d M, Y')); ?>

                                <?php if($event->end_date && $event->end_date != $event->start_date): ?>
                                    - <?php echo e(\Carbon\Carbon::parse($event->end_date)->locale('pt')->translatedFormat('d M, Y')); ?>
                        ...
                        <h3 class="event-title">
                            <a href="<?php echo e(route('evento.detalhes.bd', $event->slug)); ?>"><?php echo e($event->title); ?></a>
                        </h3>
                        <?php if($event->short_description): ?>
                        <p class="event-text"><?php echo e(Str::limit($event->short_description, 150)); ?></p>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bravantic\Desktop\Museu Municipal Alcanena\resources\views/eventos.blade.php ENDPATH**/ ?>