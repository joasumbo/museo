...
<?php $__env->startSection('title', 'Contactos - Museu Municipal de Alcanena'); ?>
<?php $__env->startSection('description', 'Entre em contacto com o Museu Municipal de Alcanena. Estamos à sua disposição para qualquer informação.'); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="contact-form-wrap" style="background: #f8f9fa; padding: 50px; border-radius: 15px;">
                    ...
                    <form action="<?php echo e(route('contactos.store')); ?>" method="POST" class="contact-form">
                        <?php echo csrf_field(); ?>
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label style="font-weight: 600; color: #333; margin-bottom: 10px; display: block;">Nome Completo *</label>
                                    <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" required style="padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; font-size: 15px;">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label style="font-weight: 600; color: #333; margin-bottom: 10px; display: block;">Email *</label>
                                    <input type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" required style="padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; font-size: 15px;">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label style="font-weight: 600; color: #333; margin-bottom: 10px; display: block;">Telefone</label>
                                    <input type="tel" class="form-control" name="phone" value="<?php echo e(old('phone')); ?>" style="padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; font-size: 15px;">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="subject" required style="padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; font-size: 15px;">
                                        ...
                                        <option value="Informações Gerais" <?php echo e(old('subject') == 'Informações Gerais' ? 'selected' : ''); ?>>Informações Gerais</option>
                                        <option value="Visitas Guiadas" <?php echo e(old('subject') == 'Visitas Guiadas' ? 'selected' : ''); ?>>Visitas Guiadas</option>
                                        <option value="Eventos" <?php echo e(old('subject') == 'Eventos' ? 'selected' : ''); ?>>Eventos</option>
                                        <option value="Exposições" <?php echo e(old('subject') == 'Exposições' ? 'selected' : ''); ?>>Exposições</option>
                                        <option value="Reservas" <?php echo e(old('subject') == 'Reservas' ? 'selected' : ''); ?>>Reservas</option>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="message" rows="6" required style="padding: 15px; border: 2px solid #e0e0e0; border-radius: 8px; font-size: 15px; resize: vertical;" placeholder="Escreva aqui a sua mensagem..."><?php echo e(old('message')); ?></textarea>
                                </div>
                            </div>
            ...
            <div class="col-lg-10">
                <div class="info-box" style="background: linear-gradient(135deg, #d4a574 0%, #c99565 100%); padding: 40px; border-radius: 15px; text-align: center;">
                    ...
                    <div style="margin-top: 25px;">
                        <a href="<?php echo e(route('horarios')); ?>" class="btn" style="background: #fff; color: #d4a574; padding: 12px 30px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Bravantic\Desktop\Museu Municipal Alcanena\resources\views/contactos.blade.php ENDPATH**/ ?>