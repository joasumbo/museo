        ...
        <div class="widget footer-widget">
            <div class="widget widget-about footer-widget">
                <div class="footer-logo">
                    <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('assets/img/logo-bordalo-pinheiro-white.svg')); ?>" alt="Museu Municipal de Alcanena"></a>
                </div>
            ...
            <ul>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="<?php echo e(url('/colecoes')); ?>">Coleções</a></li>
                    </ul>
                </li>
                <li>
                    <a href="<?php echo e(url('/galeria')); ?>">Galeria</a>
                </li>
                <li>
                    <a href="<?php echo e(url('/eventos')); ?>">Eventos</a>
                </li>
                <li>
                    <a href="<?php echo e(url('/horarios')); ?>">Horários</a>
                </li>
                <li>
                    <a href="<?php echo e(url('/contactos')); ?>">Contactos</a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto">
                        <div class="header-logo">
                            <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('assets/img/Logo_MMA.png')); ?>" alt="Museu Municipal de Alcanena" style="max-height: 80px;"></a>
                        </div>
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="col-auto d-none d-xl-block">
                        <div class="header-button">
                            <a href="<?php echo e(url('/agendar-visita')); ?>" class="btn d-none d-xl-block">
                                AGENDAR VISITA
                            </a>
...
<?php /**PATH C:\laravel_projects\museo\resources\views/layouts/header.blade.php ENDPATH**/ ?>