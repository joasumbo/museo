...
<body>
    <div class="container">
        <div class="header">
            <h2>Olá, <?php echo e($contact->name); ?>!</h2>
        </div>
        ...
        <div class="footer">
            ...
            "<?php echo e($contact->message); ?>"</p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\laravel_projects\museo\resources\views/emails/contact-reply.blade.php ENDPATH**/ ?>