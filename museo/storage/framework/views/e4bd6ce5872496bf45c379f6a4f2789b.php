  <!--==============================
            ...
            <div class="row gx-50">
                <div class="col-lg-6">
                    <div class="product-big-img">
                        <div class="img"><img src="<?php echo e(asset('assets/img/product/product-details1.png')); ?>" alt="Product Image"></div>
                    </div>
                </div>
            ...
            <div class="widget footer-widget">
                <div class="widget widget-about footer-widget">
                    <div class="footer-logo">
                        <a href="#"><img src="<?php echo e(asset('assets/img/logo-bordalo-pinheiro-white.svg')); ?>" alt="Museu Municipal de Alcanena"></a>
                    </div>
        ...
        <div class="mobile-menu-area text-center">
            ...
            <div class="mobile-menu">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('sobre')); ?>">O Museu</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('colecoes')); ?>">Coleções</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('eventos')); ?>">Eventos</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('horarios')); ?>">Horários</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('contactos')); ?>">Contactos</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto">
                            <div class="header-logo">
                                <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('assets/img/Logo_MMA.png')); ?>" alt="Museu Municipal de Alcanena" style="max-height: 80px;"></a>
                            </div>
                        </div>
                        <div class="col-auto">
                        ...
                        <div class="col-auto d-none d-xl-block">
                            <div class="header-button">
                                <a href="<?php echo e(route('agendar.visita')); ?>" class="btn d-none d-xl-block">
                                    AGENDAR VISITA
                                </a>
    ...
    </header><?php /**PATH C:\laravel_projects\museo\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>