 ...
 ******************************** -->
    ...
    <div class="preloader ">
        <div class="preloader-inner">
            <img src="<?php echo e(asset('assets/img/logo-bordalo-pinheiro-white.svg')); ?>" alt="Museu Municipal de Alcanena">
                                ...
                                <div class="col-lg-8 col-md-12">
                                    <div class="hero-style1">
                                        ...
                                        <h1 class="hero-title title-bg-thumb"
                                            data-bg-src="<?php echo e(asset('assets/img/hero/hero_1_text-bg.png')); ?>"
                            ...
                            <div class="col-lg-4 col-md-6 exhibition-card-wrap">
                                <div class="exhibition-card gtop">
                                    ...
                                    <div class="exhibition-card-details">
                                        ...
                                        <a class="btn style2"
                                            href="<?php echo e(route('eventoShow', $exhibition->slug)); ?>">SABER MAIS</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row global-carousel portfolio-slider1 gx-20" data-slide-show="3">
                            ...
                            <div class="portfolio-card ">
                                <div class="portfolio-thumb">
                                    <a class="popup-image icon-btn"
                                        href="<?php echo e(asset('assets/img/portfolio/mma_portfolio_1.jpg')); ?>"><i
                                            class="far fa-eye"></i></a>
                                    <img src="<?php echo e(asset('assets/img/portfolio/mma_portfolio_1.jpg')); ?>"
                                        alt="portfolio">
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="portfolio-card ">
                                <div class="portfolio-thumb">
                                    <a class="popup-image icon-btn"
                                        href="<?php echo e(asset('assets/img/portfolio/mma_portfolio_2.jpg')); ?>"><i
                                            class="far fa-eye"></i></a>
                                    <img src="<?php echo e(asset('assets/img/portfolio/mma_portfolio_2.jpg')); ?>"
                                        alt="portfolio">
                                </div>
                                <div class="portfolio-details">
                        ...
                        <div class="col-lg-4">
                            <div class="portfolio-card ">
                                <div class="portfolio-thumb">
                                    <a class="popup-image icon-btn"
                                        href="<?php echo e(asset('assets/img/portfolio/mma_portfolio_3.jpg')); ?>"><i
                                            class="far fa-eye"></i></a>
                                    <img src="<?php echo e(asset('assets/img/portfolio/mma_portfolio_3.jpg')); ?>"
                                        alt="portfolio">
                                </div>
                                <div class="portfolio-details">
                            ...
                            <div class="col-lg-12">
                                <div class="event-card wow custom-anim-left" data-wow-duration="1.5s"
                                    ...
                                    <div class="event-card-date">
                                        ...
                                        <?php echo e($event->start_date->locale('pt')->translatedFormat('F, Y')); ?>

                                    </div>

                                    <div class="event-card-details">
                                        <h3 class="event-card-title">
                                            <a href="<?php echo e(route('eventoShow', $event->slug)); ?>">
                                        ...
                                        <span class="event-card-location">
                                            ...
                                            <?php echo e($event->location ?? 'Museu Municipal'); ?>
                                        ...
                                        <a href="<?php echo e(route('eventoShow', $event->slug)); ?>" class="btn">
                                            SABER MAIS
                                        </a>
                                    </div>
                                    ...
                                    <div class="event-card-thumb">
                                        ...
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('assets/img/event/mma_event_1.jpg')); ?>"
                                                alt="<?php echo e($event->title); ?>">
                                        <?php endif; ?>
                                    </div>
                                </div>
                ...
                <div class="row gy-4">
                    <div class="col-lg-3 col-md-6">
                        <div class="product-card wow custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.1s">
                            <div class="product-img">
                                ...
                                <img src="<?php echo e(asset('assets/img/product/1-1.png')); ?>" alt="Product Image">
                                <div class="actions">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-card wow custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.1s">
                            <div class="product-img">
                                <span class="tag">Sculptor</span>
                                <img src="<?php echo e(asset('assets/img/product/1-2.png')); ?>" alt="Product Image">
                                <div class="actions">
                                    <a href="cart.html" class="icon-btn"><i class="fas fa-shopping-cart"></i></a>
                                    <a href="wishlist.html" class="icon-btn"><i class="far fa-heart"></i></a>
                                    <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-card wow custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.1s">
                            <div class="product-img">
                                <span class="tag">Sculptor</span>
                                <img src="<?php echo e(asset('assets/img/product/1-3.png')); ?>" alt="Product Image">
                                <div class="actions">
                                    <a href="cart.html" class="icon-btn"><i class="fas fa-shopping-cart"></i></a>
                                    <a href="wishlist.html" class="icon-btn"><i class="far fa-heart"></i></a>
                                    <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="product-card wow custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.1s">
                            <div class="product-img">
                                <span class="tag">Sculptor</span>
                                <img src="<?php echo e(asset('assets/img/product/1-4.png')); ?>" alt="Product Image">
                                <div class="actions">
                                    <a href="cart.html" class="icon-btn"><i class="fas fa-shopping-cart"></i></a>
                                    <a href="wishlist.html" class="icon-btn"><i class="far fa-heart"></i></a>
                                    <a href="#QuickView" class="icon-btn popup-content"><i class="far fa-eye"></i></a>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 text-lg-end text-center">
                            <div class="wow custom-anim-right" data-wow-duration="1.5s" data-wow-delay="0.2s">
                                <a href="<?php echo e(route('agendar.visita')); ?>" class="btn"
...
<?php /**PATH C:\laravel_projects\museo\resources\views/home.blade.php ENDPATH**/ ?>