...
<head>
    ...
    <title>{{ $evento['title'] }} - Museu Municipal de Alcanena</title>
...
<body>
    ...
    <div id="smooth-wrapper">
        <div id="smooth-content">
            ...
            <div class="breadcumb-wrapper text-center" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('{{ asset('storage/' . $evento->image) }}'); padding: 140px 0 80px; background-position: center; background-size: cover;" >
                <!-- bg animated image/ -->
                <div class="container">
                    <br><br>
                    <br><br>
                    ...
                    <h1 class="breadcumb-title">{{ $evento['title'] }}</h1>
                    <ul class="breadcumb-menu">
                        <li><a href="{{ url('/') }}">INÍCIO</a></li>
                        <li><a href="{{ url('/eventos') }}">EVENTOS</a></li>
                        <li class="active">{{ strtoupper($evento['title']) }}</li>
                    </ul>                
                </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="event-details-title-wrap">
                    <div class="title-area">
                        <h3 class="subtitle">
                            <i class="far fa-calendar-alt"></i>  {{ $evento->getFormattedDateRange() }}</a>
                        </h3>
                    </div>
                </div>
                <div class="event-details-thumb">
                  
                    <span class="tag">{{ $evento['type'] }}</span>
