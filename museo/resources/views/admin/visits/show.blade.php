                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="text-xs text-gray-500">
                                    {{ \Carbon\Carbon::parse($visit->preferred_time)->format('H:i') }}</p>
                            </div>
                            <div>
                                <p class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Hora</p>
                                <p class="text-lg font-medium text-white"> {{ \Carbon\Carbon::parse($visit->preferred_time)->format('H:i') }}</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-2">
                                <span class="text-2xl font-bold text-white">{{ $visit->group_size ?? '' }}</span>
                            ...
                            <div>
                                ...
                                <dd class="mt-1">
                                    <a href="mailto:{{ $visit->email }}"
                                        class="text-sm text-accent hover:text-accent-hover">{{ $visit->email }}</a>
                                </dd>
                            </div>
                            @if ($visit->phone)
                                <div>
                                    ...
                                    <dd class="mt-1">
                                        <a href="tel:{{ $visit->phone }}"
                                            class="text-sm text-gray-300 hover:text-white">{{ $visit->phone }}</a>
                                    </dd>
                                </div>
                            @endif
