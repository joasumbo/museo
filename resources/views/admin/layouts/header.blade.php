    ...
    <div class="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center">
            ...
            <nav class="hidden sm:flex items-center space-x-2 text-sm">
                <a href="{{ route('admin.dashboard') }}" class="text-gray-500 hover:text-gray-300">Admin</a>
                <svg class="h-4 w-4 text-gray-600" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
                </svg>
                <span class="text-gray-300">@yield('page-title', 'Dashboard')</span>
            </nav>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="hidden md:flex items-center space-x-4 text-sm">
                @php $todayVisits = \App\Models\Visit::today()->whereIn('status', ['pending', 'confirmed'])->count(); @endphp
                @if($todayVisits > 0)
                    <div class="flex items-center text-gray-400">
                        <svg class="h-4 w-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                        </svg>
                        <span>{{ $todayVisits }} visitas hoje</span>
                    </div>
                @endif
            </div>
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" 
                    ...
                    <div class="py-1">
                        ...
                        <a href="{{ route('admin.settings.profile') }}" class="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-admin-hover hover:text-white">
                        ...
                        <a href="{{ route('admin.settings.password') }}" class="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-admin-hover hover:text-white">
                            <svg class="mr-3 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
