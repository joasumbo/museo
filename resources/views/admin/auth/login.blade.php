    ...
    <div class="flex min-h-full items-center justify-center px-4 py-12 sm:px-6 lg:px-8 relative z-10">
        <div class="w-full max-w-md space-y-8 fade-in-up">
            ...
            <div class="text-center">
                <img src="{{ asset('assets/img/Logo_MMA.png') }}" alt="Museu Municipal de Alcanena" class="mx-auto h-24 w-auto logo-glow">
            ...
            <div class="text-center">
                <p class="text-xs text-gray-500">
                    © {{ date('Y') }} Museu Municipal de Alcanena. Todos os direitos reservados.
                </p>
            </div>
        </div>
    </div>
