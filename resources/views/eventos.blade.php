        ...
        <div class="breadcumb-wrapper text-center" data-bg-src="{{ asset('assets/img/bg/breadcrumb-bg.png') }}">
            ...
            <div class="container">
                <div class="breadcumb-content">
                    <h1 class="breadcumb-title">Event Page</h1>
                </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-center exhibition-wrap-1 gy-40 gx-30">
                    <div class="col-lg-4 col-md-6 exhibition-card-wrap">
                        <div class="exhibition-card">
                            <div class="exhibition-card-thumb">
                                <img src="{{ asset('assets/img/exhibition/1-1.png') }}" alt="img">
                    ...
                    <div class="col-lg-4 col-md-6 exhibition-card-wrap">
                        <div class="exhibition-card">
                            <div class="exhibition-card-thumb">
                                <img src="{{ asset('assets/img/exhibition/1-2.png') }}" alt="img">
                                <div class="shadow-text">Sculptor</div>
                            </div>
                            <div class="exhibition-card-details">
                                <div class="post-meta-item blog-meta">
                    ...
                    <div class="col-lg-4 col-md-6 exhibition-card-wrap">
                        <div class="exhibition-card">
                            <div class="exhibition-card-thumb">
                                <img src="{{ asset('assets/img/exhibition/1-3.png') }}" alt="img">
                                <div class="shadow-text">Sculptor</div>
                            </div>
                            <div class="exhibition-card-details">
                                <div class="post-meta-item blog-meta">
                    ...
                    <div class="col-lg-4 col-md-6 exhibition-card-wrap">
                        <div class="exhibition-card">
                            <div class="exhibition-card-thumb">
                                <img src="{{ asset('assets/img/exhibition/1-4.png') }}" alt="img">
                                <div class="shadow-text">Sculptor</div>
                            </div>
                            <div class="exhibition-card-details">
                                <div class="post-meta-item blog-meta">
                                ...
                                <h3 class="event-card-title"><a href="event.html">Artful Archive Project</a></h3>
                                <a class="btn style2" href="event.html">SCULPTOR</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 exhibition-card-wrap">
                        <div class="exhibition-card">
                            <div class="exhibition-card-thumb">
                                <img src="{{ asset('assets/img/exhibition/1-5.png') }}" alt="img">
                                <div class="shadow-text">Sculptor</div>
                            </div>
                            <div class="exhibition-card-details">
                                <div class="post-meta-item blog-meta">
                                ...
                                <h3 class="event-card-title"><a href="event.html">Exhibitions Ensemble</a></h3>
                                <a class="btn style2" href="event.html">SCULPTOR</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 exhibition-card-wrap">
                        <div class="exhibition-card">
                            <div class="exhibition-card-thumb">
                                <img src="{{ asset('assets/img/exhibition/1-6.png') }}" alt="img">
                                <div class="shadow-text">Sculptor</div>
                            </div>
                            <div class="exhibition-card-details">
                                <div class="post-meta-item blog-meta">
